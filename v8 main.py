...
try:
    ...
    reflectance = getattr(defaults, "reflectance", _FallbackReflectance())
    drivetrain = getattr(defaults, "drivetrain", _FallbackDrivetrain())
    distance = getattr(defaults, "distance", _FallbackDistance())
except Exception:
    reflectance = _FallbackReflectance()
    drivetrain = _FallbackDrivetrain()
